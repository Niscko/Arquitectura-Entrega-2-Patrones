...
namespace Bib_Hacienda.Clases
{
    public abstract class Res
    {
        ...
        //Composición: objetos de valor opcionales (ADR-08 — SRP/OCP)
        //Chip de geolocalización (0..1) — no altera constructor ni subclases
        public Chip Chip { get; set; }
        //Historia clínica (0..1) — no altera constructor ni subclases
